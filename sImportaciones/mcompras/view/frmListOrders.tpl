...
<a href="prnBoletaBodega.php?idPedido={$LIST_PEDIDOS[p].idPedido}" target="_blank" title="Boleta Ingreso Mercaderia"id="{$LIST_PEDIDOS[p].idPedido}" ><i class="icon icon-color icon-clipboard"></i></a>
