<?php /* Smarty version Smarty-3.1.16, created on 2017-04-08 09:29:20
         compiled from "../mcompras/view/invLoad.tpl" */ ?>
<?php /*%%SmartyHeaderCode:64578419158d9f0a8349de0-35948416%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4bdcc76c6efae61df112f47324bafde147e0c077' => 
    array (
      0 => '../mcompras/view/invLoad.tpl',
      1 => 1491665337,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64578419158d9f0a8349de0-35948416',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_58d9f0a841ac61_54532273',
  'variables' => 
  array (
    'INVENTARIO' => 0,
    'names_count' => 0,
...
<?php if ($_valid && !is_callable('content_58d9f0a841ac61_54532273')) {function content_58d9f0a841ac61_54532273($_smarty_tpl) {?><table class="table table-condensed bootstrap-datatable" id="tblAllInventary" style="width:1200px">
  <thead>
        <tr> 
...
?>    
    <tr id="inv-rowArt1">
        ...
        <td class="center" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['INVENTARIO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['FecUltCompra'];?>
</td>
        <td class="center" style="text-align: right;<?php if ($_smarty_tpl->tpl_vars['INVENTARIO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['CantUltCompra']<=0) {?> color:red<?php }?>"><?php echo $_smarty_tpl->tpl_vars['INVENTARIO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['CantUltCompra'];?>
</td>
        <td class="center" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['INVENTARIO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['FecUltVenta'];?>
</td>
        <td class="center" style="text-align: right;">
            <input name="cantPed[]" id="<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['i']['index'];?>
" type=number style="text-align: right; width:60px;" value="0">
        </td>     
        <td class="center">
