<?php /* Smarty version Smarty-3.1.16, created on 2017-10-20 11:50:50
         compiled from "../invtlineas/view/allData.tpl" */ ?>
<?php /*%%SmartyHeaderCode:193981588057e2c7c91cb947-56411289%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65b1e64d022230edbedf24c0245f02e374786a22' => 
    array (
      0 => '../invtlineas/view/allData.tpl',
      1 => 1477417373,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193981588057e2c7c91cb947-56411289',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57e2c7c91ddc06_45432039',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'LISTA_DATA' => 0,
...
<?php if ($_valid && !is_callable('content_57e2c7c91ddc06_45432039')) {function content_57e2c7c91ddc06_45432039($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>

	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>Administración de Lineas</h2>
			</div>
			<div class="box-content">
				<button type="button" class="btn btn-small btn-success" id="addNewData" title="Agregar Nueva Linea" data-rel="tooltip" onclick="goPage(1,0)" style="margin-bottom:12px;"><i class="icon-plus icon-white"></i> Agregar</button>
...
?> 								
						<tr style="padding:0px;" id="tr<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idTipoLinea'];?>
">
     						<td style="width:40px;"><?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idTipoLinea'];?>
</td>  
							...
							<td class="center">
								<a class="btn btn-primary" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idTipoLinea'];?>
" title="Modificar Datos" data-rel="tooltip" onclick="goPage(2, this.id)"><i class="icon-edit icon-white"></i>  Modificar</a>
								<a class="btn btn-danger" href="" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idTipoLinea'];?>
" title="Eliminar " data-rel="tooltip" onclick="goPage(3, this.id)"><i class="icon-trash icon-white"></i> Eliminar</a>
								<!--  
								<a class="btn btn-warning" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idTipoLinea'];?>
