<?php
    ...
    $consnotacrcxc   = $_POST["fconsecNotaCrCxC"];
    ...
    switch($action){
        case 1: // insertar
                ...
                $result = $model->insertarData($id,$nombt,$nomcia,$cjurid,$dir,$ubic,$telf,$textad,$corr,$leytri,$confac,$conpro,$conaprt,$conrep,$conajs,$contrasl,$tipomosal,$tipomoen,$consnotacr,$confactman,$conseclien,$consnotacrcxc);
                
            break;
            
        case 2: // modificar
            
                $result = $model->modificarData($id,$nombt,$nomcia,$cjurid,$dir,$ubic,$telf,$textad,$corr,$leytri,$confac,$conpro,$conaprt,$conrep,$conajs,$contrasl,$tipomosal,$tipomoen,$consnotacr,$confactman,$conseclien,$consnotacrcxc);
        ...
        case 5: // modificar consecutivo
            ...
            break;   
        case 6: // modificar consecutivo
                
                $result = $model->modificarConsecNota($id,$consnotacrcxc);
