<?php /* Smarty version Smarty-3.1.16, created on 2017-03-30 10:40:56
         compiled from "../store/view/allData.tpl" */ ?>
<?php /*%%SmartyHeaderCode:138321944557d6eaf548db80-88908165%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '138321944557d6eaf548db80-88908165',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57d6eaf55aa3c9_47979908',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'ANULAMOD_OFF' => 0,
    ...
    'ANULADELETE_OFF' => 0,
    'ANULACONSEC_OFF' => 0,
    'ANULACONSECNOTA_OFF' => 0,
    'LISTA_DATA' => 0,
    'LISTA_FACTPROVEEDOR' => 0,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d6eaf55aa3c9_47979908')) {function content_57d6eaf55aa3c9_47979908($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
...
">
				<input type="hidden" id="anulaCONSECNOTA" value="<?php echo $_smarty_tpl->tpl_vars['ANULACONSECNOTA_OFF']->value;?>
">
...
" title="Ver Tienda" data-rel="tooltip" onclick="goPage(4, this.id)"><i class="icon-zoom-in icon-white"></i> Visualizar</a>
								...
								<a <?php if ($_smarty_tpl->tpl_vars['ANULACONSEC_OFF']->value=="S") {?>  class="hidden" <?php }?> class="btn btn-warning" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['codTienda'];?>
" title="Consecutivo" data-rel="tooltip" onclick="goPage(5, this.id)"><i class="icon-edit icon-white"></i> Consecutivo</a>

								<a <?php if ($_smarty_tpl->tpl_vars['ANULACONSECNOTA_OFF']->value=="S") {?>  class="hidden" <?php }?> class="btn btn-warning" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['codTienda'];?>
" title="Nota CR" data-rel="tooltip" onclick="goPage(6, this.id)"><i class="icon-edit icon-white"></i> Consec Nota CR</a>
							</td>
						</tr> 
					<?php endfor; endif; ?>
				</table>  
