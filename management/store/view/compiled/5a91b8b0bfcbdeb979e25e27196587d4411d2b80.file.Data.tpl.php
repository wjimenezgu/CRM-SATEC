<?php /* Smarty version Smarty-3.1.16, created on 2017-03-30 10:41:01
...
">
				 	...
				 	<div class="control-group" id="boxconsecNotaCR" >
						<label class="control-label" for="focusedInput">#Consecutivo Nota CR*</label>
						<div class="controls">
							<input class="input-xlarge focused" name ="fconsecNotaCrCxC" id="fconsecNotaCrCxC" maxlength="50" type="text" value="<?php echo $_smarty_tpl->tpl_vars['DATA']->value[0]['consecNotaCrCxC'];?>
">
						</div>
				 	</div>				 					 			
