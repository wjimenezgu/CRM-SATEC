<?php /* Smarty version Smarty-3.1.16, created on 2016-10-24 10:21:12
         compiled from "../tlineas/view/Data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:54923466657d850b8ea7ba9-72869048%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8621f2ccd29f8dcf044ea54c19f00f92f54b681f' => 
    array (
      0 => '../tlineas/view/Data.tpl',
      1 => 1476216339,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '54923466657d850b8ea7ba9-72869048',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57d850b90101b0_78359317',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'ACTION' => 0,
...
<?php if ($_valid && !is_callable('content_57d850b90101b0_78359317')) {function content_57d850b90101b0_78359317($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>

	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>Información de Lineas</h2>
			</div>
...
">						
 			 	<fieldset>
					<div class="control-group" id="boxId" >
						...
						<div class="controls">
							<input readonly class="input-xlarge " name="fId" id="fId" type="text" style="text-transform:uppercase" placeholder="Digite" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['ID']->value;?>
...
">
				                            ...
				                            <td style="width:150px;" align="left"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['descripcion'], 'UTF-8'));?>
</td>
				                            <td style="width:150px;" align="left"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['linea1'], 'UTF-8'));?>
</td>
				                            <td style="width:150px;" align="left"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['linea2'], 'UTF-8'));?>
</td>
				                            <td style="width:150px;" align="left"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['linea3'], 'UTF-8'));?>
</td>
