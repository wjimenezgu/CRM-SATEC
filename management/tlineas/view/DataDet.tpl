				...
				<form class="form-horizontal" id="frmData" action="processDataDet.php" method="POST">
 			 	...
 			 	<fieldset>
	        		...
	        		<label id="flid" class="control-label" for="disabledInput">Tipo Linea*</label>
						<div class="controls">
							<input readonly class="input-xlarge " name="ftipolinea" id="ftipolinea" type="text" style="text-transform:uppercase" placeholder="{$ID}" maxlength="3" value="{$ID}" readonly="true" >
						</div>
					</div>
                 	<div class="control-group" id="boxId" >
	        		<label id="flid" class="control-label" for="disabledInput">ID Linea*</label>
						<div class="controls">
							<input readonly class="input-xlarge " name="fId" id="fId" type="text" style="text-transform:uppercase" maxlength="3" placeholder="{$TIPOLINEA}" value="{$TIPOLINEA}" readonly="true" >
						</div>
					</div>
		               <div class="control-group" id="boxdescripcion" >
					 <label id="flnl" class="control-label" for="disabledInput">Descripcion*</label>
						<div class="controls">
							<input class="input-xlarge " name="fdescripcion" id="fdescripcion" type="text" style="text-transform:uppercase" placeholder="Digite Descripcion" maxlength="100" value="{$DATA[0].descripcion}"  >
						</div>
                	</div>	
					...
					<div class="control-group" id="boxLinea1" >
						...
						<div class="controls">
							<input class="input-xlarge " name="flinea1" id="flinea1" type="text" style="text-transform:uppercase" placeholder="Digite Linea 1" maxlength="100" value="{$DATA[0].linea1}"  >
						</div>
                     	</div>				
                        <div class="control-group" id="boxLinea2">
						<label class="control-label" for="disabledInput">Linea 2*</label>
						<div class="controls">
							<input class="input-xlarge " name="flinea2" id="flinea2" type="text" style="text-transform:uppercase" placeholder="Digite Linea 2" maxlength="100" value="{$DATA[0].linea2}"  >
						</div>
				 	</div>	
				 	<div class="control-group" id="boxLinea3">
						<label class="control-label" for="disabledInput">Linea 3*</label>
						<div class="controls">
							<input class="input-xlarge " name="flinea3" id="flinea3" type="text" style="text-transform:uppercase" placeholder="Digite Linea 3" maxlength="100" value="{$DATA[0].linea3}"  >
						</div>
				 	</div>	
