				...
				<form class="form-horizontal" id="frmData" action="processData.php" method="POST">
 			 	...
 			 	<fieldset>
					<div class="control-group" id="boxnombre" >
						...
						<div class="controls">
							<input class="input-xlarge " name="fuserVendedor" id="fuserVendedor" type="text" style="text-transform:uppercase" placeholder="Indicar Usuario" maxlength="15" value="{$USERVENDEDOR}" {if $ACTION eq 2} readonly="true"{/if} >
						</div>
					</div>
					...
					<div class="control-group" id="boxdescripcion" >
						...
						<div class="controls">
							<input class="input-xxlarge focused" name ="fnombreVendedor" id="fnombreVendedor" maxlength="200"  type="text" value="{$DATA[0].nombreVendedor}">
						</div>
				 	</div>
