	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>Información Usuarios por Tienda</h2>
			</div>
				...
				<form class="form-horizontal" id="frmData" action="processData.php" method="POST">
 			 	...
 			 	<fieldset>
					...
					<div class="control-group" id="boxdescripcion" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fcodtienda" id="fcodtienda" maxlength="100"  type="text" value="{$DATA[0].codTiendaLocal}">
					    </div>
					</div>
				 	</div>
