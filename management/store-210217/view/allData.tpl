					...
					{section name=lP loop=$LISTA_DATA} 								
						<tr style="padding:0px;" id="tr{$LISTA_DATA[lP].codTienda}">
							...
							<td class="center">
								...
								<a {IF $ANULACONSEC_OFF eq "N"}  class="hidden" {/if} class="btn btn-warning" href="#" id="{$LISTA_DATA[lP].codTienda}" title="Consecutivo" data-rel="tooltip" onclick="goPage(5, this.id)"><i class="icon-edit icon-white"></i> Consecutivo</a>
							</td>
						</tr> 
					{/section}
				</table>  
