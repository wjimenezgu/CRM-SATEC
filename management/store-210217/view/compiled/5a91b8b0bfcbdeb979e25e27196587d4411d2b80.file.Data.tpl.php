<?php /* Smarty version Smarty-3.1.16, created on 2017-02-14 14:08:28
         compiled from "../store/view/Data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:56888523258755a15bd2503-54098176%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '56888523258755a15bd2503-54098176',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_58755a15d0ee44_19239088',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'ACTION' => 0,
...
<?php if ($_valid && !is_callable('content_58755a15d0ee44_19239088')) {function content_58755a15d0ee44_19239088($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
$(document).ready(function(){
	...
	if (newAction.value == "3" || newAction.value == "4" ){
		...
		$("#boxcliente").css("display","none"); */     //OCULTAR CAMPOS
	}else
	    if(newAction.value == "5"){
	    $("#boxId :input").attr('readonly', true);
		$("#boxdescripcion :input").attr('readonly', true);
		$("#boxcia :input").attr('readonly',true);
		$("#boxjuridica :input").attr('readonly',true);
		$("#boxdireccion :input").attr('readonly',true);
		$("#boxubicacion :input").attr('readonly',true);
		$("#boxtelefono :input").attr('readonly',true);
		$("#boxtexaddi :input").attr('readonly',true);
		$("#boxcorreo :input").attr('readonly',true);
		$("#boxleyenda :input").attr('readonly',true);
		$("#boxfactura :input").attr('readonly',true);
		$("#boxproforma :input").attr('readonly',true);
		$("#boxapartados :input").attr('readonly',true);
		$("#boxreparaciones :input").attr('readonly',true);
		$("#boxajustes :input").attr('readonly',true);
		$("#boxtraslados :input").attr('readonly',true);
        $("#boxmovsal :input").attr('readonly',true);
		$("#boxmovent :input").attr('readonly',true);
		$("#boxnotacr :input").attr('readonly',true);
		$("#boxfacmanual :input").focus();
		$("#boxcliente :input").attr('readonly',true);
