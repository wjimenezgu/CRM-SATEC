				...
				<table class="table table-striped table-bordered bootstrap-datatable" id="tblData">
					...
					{section name=lP loop=$LISTA_DATA} 								
						<tr style="padding:0px;" id="tr{$LISTA_DATA[lP].id}">
                            <td style="width:5%;font-family:monospace;" align="left">{$LISTA_DATA[lP].id}</td>
                            <td style="width:15%;font-family:monospace;" align="left">{$LISTA_DATA[lP].descCorta}</td>
                            <td style="width:20%;font-family:monospace;" align="left">{$LISTA_DATA[lP].descLarga}</td>
                            <td style="width:10%;font-family:monospace;" align="left">{$LISTA_DATA[lP].posLista}</td>
							<td style="width:30%;font-family:monospace;" class="center">
								<a class="btn btn-primary" href="#" id="{$LISTA_DATA[lP].id}" title="Modificar ;" data-rel="tooltip" onclick="goPage(2, this.id)"><i class="icon-edit icon-white"></i>  Modificar</a>
