<?php /* Smarty version Smarty-3.1.16, created on 2017-03-14 10:02:05
         compiled from "../profiles/view/Data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:43326719457eadbc7b670e6-18286349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2450fa3a6f1e7a950a1a197b9a23d06175aeb6b' => 
    array (
      0 => '../profiles/view/Data.tpl',
      1 => 1489506359,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '43326719457eadbc7b670e6-18286349',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57eadbc7b87140_41528920',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'ACTION' => 0,
...
<?php if ($_valid && !is_callable('content_57eadbc7b87140_41528920')) {function content_57eadbc7b87140_41528920($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
...
">						
 			 	<fieldset>
					<div class="control-group" id="boxId" >
						<label id="flid" class="control-label" for="disabledInput">ID Perfil*</label>
						<div class="controls">
...
" <?php if ($_smarty_tpl->tpl_vars['ACTION']->value==2) {?> readonly="true"<?php }?> >
					...
					<div class="control-group" id="boxdescripcion">
						<label class="control-label" for="focusedInput">Nombre Perfil*</label>
						<div class="controls">
							<input class="input-xlarge focused" name ="fusername" id="fusername" maxlength="50" type="text" value="<?php echo $_smarty_tpl->tpl_vars['DATA']->value[0]['profileName'];?>
">
						</div>
				 	</div>	
...
">
				     						<td style="width:40px;"><?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idProfile'];?>
</td>  
				                            <td style="width:385px;" align="left"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['username'], 'UTF-8'));?>
</td>
											<td class="center">
												<a class="btn btn-primary" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['username'];?>
...
,this.id)"><i class="icon-edit icon-white"></i>  Modificar</a>
												<a class="btn btn-danger" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['username'];?>
...
, this.id)"><i class="icon-trash icon-white"></i> Eliminar</a>
												...
												<a class="btn btn-warning" href="#" id="<?php echo $_smarty_tpl->tpl_vars['LISTA_DATA']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['username'];?>
