<?php /* Smarty version Smarty-3.1.16, created on 2016-12-14 13:18:52
...
" <?php if ($_smarty_tpl->tpl_vars['PROVEEDORES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['idProveedor']==$_smarty_tpl->tpl_vars['PEDIDO_NAC']->value[0]['idProveedor']) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['PROVEEDORES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['nombreProveedor'];?>
                            ...
                            <div class="control-group" id="boxObs" style="margin-left: -75px;width:100%;">
				            	...
				            	<div class="controls">   									
									<input class="focused" style="width:100%;" name="comentarios" id="comentarios" type="text" placeholder="Observaciones" value="<?php echo $_smarty_tpl->tpl_vars['PEDIDO_NAC']->value[0]['comentarios'];?>
" >
								</div>
							</div> 
