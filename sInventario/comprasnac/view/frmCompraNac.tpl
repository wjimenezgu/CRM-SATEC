        	...
        	<div class="row-fluid" >		
            	<div class="box span12">
                	<div class="box-header well" data-original-title>
                    	<h2>ORDEN DE COMPRA {if $ACTION neq "1"}NO. | {$PEDIDO_NAC[0].numOrdenCompra}{/if}</h2>                    	    
                    </div>
                    <div id="message-fields" style='alignment-adjust:  central;'></div>
                            ...
                            <div class="control-group" id="boxObs" style="margin-left: -75px;width:100%;">
				            	<label class="control-label" for="comentarios">Obs</label>	
				            	<div class="controls">   									
									<input class="focused" style="width:100%;" name="comentarios" id="comentarios" type="text" placeholder="Observaciones" value="{$PEDIDO_NAC[0].comentarios}" >
								</div>
							</div> 

                        			    <div class="control-group" style="float:left;margin-left:-50px;" id="boxTipoCambio">
							...
							<div class="control-group" id="boxFecMovi">
								...
								<div class="controls">
									<input class="input-medium focused datepicker" style="float: left;margin-left:10px;" id="fecMoviI" type="text" placeholder="Fecha Inicial" value="{$CURRENT_DATE}" >
								</div>
							</div>		
                        	...
                        	<table class="table table-striped table-bordered bootstrap-datatable" id="tableItem">
                                ...
                                <tbody id="tbod" name="tbod" onload="LimpiaCampos()">
                                	...
                                	{section name=lP loop=$DETPEDIDO_NAC} 								
						    			...
						    			<td >{$DETPEDIDO_NAC[lP].idLinea}</td>
						    			<td >{$DETPEDIDO_NAC[lP].descArti}
     									...
     									<td style="text-align:right;">
     										<input name="costPed[]" id="{$DETPEDIDO_NAC[lP].idLinea}" type=number style="text-align: right; width:100px;" value="{$DETPEDIDO_NAC[lP].costoUnitario}">
     									</td>
										<td class="center">
...
<!-------------------------- MODAL ARTICULOS ---------------------------------->
<div class="modal fade" id="inventory-modal" tabindex="-1" role="dialog" data-refresh="true"  aria-hidden="true" style="margin: -320px 0 0 -480px;width:1000px">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"> 
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
  ...
  //Inserta un cliente por medio de AJAX y lo añade a los datos del cliente en la factura
    ...
    cache.$btnInventario.on("click", function(e){
          ...
          var properties = {
                     ...
                     async: true,
                     cache: false,
                     data: "txtBuscar="+vtxtBusqueda+"&criterio="+vcriterio+"&fecIni="+$("#fecMoviI").val(),
                     type: "GET",
