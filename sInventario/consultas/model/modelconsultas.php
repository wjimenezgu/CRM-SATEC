...
class modelconsultas{
    ...
    function buscarExistencias($tienda,$fechaCorte,$criterio, $texto) {
    	...
    	$sql = "call spGetArtiExistenciasFechaCosto('$criterio',$tienda,'$fechaCorte',$idCodigo,$descripcion,$codigoExterno,@out_status);";
 	//  echo $sql;exit;
    	$rs = $this->db->Execute($sql);
    ...
    function buscarReparaciones($idTienda,$criterio,$fechaI,$fechaF) {
        $sql = "call spGetAllReparacionesReporte($idTienda,'$criterio','$fechaI','$fechaF',@out_status);";
        //echo $sql;exit;
    ...
    function getAllFacturas($idTienda) {
    	...
    	$sql = "call spGetAllFacturasConsulta($idTienda,@out_status);";
    	$rs = $this->db->Execute($sql);
    	$data = $rs->getArray();
    	$rs->Close();
    	return $data;
