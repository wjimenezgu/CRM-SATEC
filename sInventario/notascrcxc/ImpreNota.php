<?php 
   ...
   $detalleDocu = $model->buscarDetNotaArti($idNota);
    ...
    //$limpieza1 = str_replace("+", " ", $enc);       //ELIMINA SIGNO "+" DENTRO DE NOMBRE Y DIRECCION
    // $enc = $limpieza1 ;

    //$limpieza2 = str_replace("%", " ", $enc);       //ELIMINA SIGNO "%" DENTRO DE NOMBRE Y DIRECCION
    // $enc = $limpieza2 ;

    //$limpieza3 = str_replace("#", "No.", $arti);   //REEMPLAZA SIGNO "#" POR "No." DENTRO DE DESCRIPCION
     //$arti = $limpieza3 ;
...
<body>
    ...
    <div style="width:100%">
    	...
    	<input type="button" id="imprime" autofocus name="imprime"   style="margin-left:25%; margin-top:25%;font-size:48px" onclick="javascript:jsWebClientPrint.print('enc=' + $('#enc').val()+'&arti=' + $('#arti').val()); window.location.href ='../notascrcxc/index.php';" value="Presionar Enter para regresar ..." />
