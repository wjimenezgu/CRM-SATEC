			...
			<div class="box-content">
				<form class="form-horizontal" id="frmEditItem"  action="processItem.php"  method="POST">
				 ...
				 <div class="control-group" id="boxfexistencia">
					...
					<div class="controls">
						<input class="input-xlarge focused" name="fexistencia" id="fexistencia" type="text" value="{$ITEM[0].existencia}"
						{IF $EXISTENCIA_OFF eq "S"}  readonly="true" {/if}>
					</div>
				 </div>
				 <div class="control-group" id="boxfecexistencia">
					<label class="control-label" for="focusedInput">Fec.Existencia</label>
					<div class="controls">
						<input class="input-xlarge focused" name="fecexistencia" id="fecexistencia" type="text" value="{$ITEM[0].fecExistencia} " readonly="true">
					</div>
				 </div>
