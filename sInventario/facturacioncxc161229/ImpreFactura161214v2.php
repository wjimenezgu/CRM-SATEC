<?php
    ...
    $cmds .= substr($tiraEsp,1,20) . substr($tiraEsp,1,73) . 
             substr($headerDocu[0]["telefono"],0,10).
             substr($tiraEsp,1,10-strlen($dato["telefono"])) . 
       //      substr($tiraEsp,1,12) . $headerDocu[0]["numOC"];  // TELEFONO Y NUMOC
    		  $headerDocu[0]["numOC"];  // TELEFONO Y NUMOC
    // linea original
    ...
    $cmds .= $SaltarLineas;
    $cmds .= substr($tiraEsp,1,90) ."       Total:               " .substr($tiraEsp,1,12-strlen($headerDocu[0]["subTotalArticulos"])).$headerDocu[0]["subTotalArticulos"];
    $cmds .= $newLine ;   
    $cmds .= substr($tiraEsp,1,90) ."       Descuento:           " .substr($tiraEsp,1,12-strlen($headerDocu[0]["descuento"])).$headerDocu[0]["descuento"];
    $cmds .= $newLine . $newLine ;

    // la cantidad de dias la trae el encabezado de la factura
    $cmds .= substr($tiraEsp,1,12) .substr($tiraEsp,1,3-strlen($dato["plazoCredi"])) .$headerDocu[0]["plazoCredi"].
    ...
    $cmds .= $newLine . $newLine ;
    $cmds .= substr($tiraEsp,1,90) ."                            ".substr($tiraEsp,1,12-strlen($headerDocu[0]["impuesto"])).$headerDocu[0]["impuesto"];
    $cmds .= $newLine . $newLine ;
    $cmds .= substr($tiraEsp,1,90) ."                            ".substr($tiraEsp,1,12-strlen($headerDocu[0]["Total"])).$headerDocu[0]["Total"];
