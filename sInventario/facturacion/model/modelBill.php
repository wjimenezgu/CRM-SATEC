...
//echo $sql;exit;
    ...
    function getTiendaLocal($userName) {
     ...
     function buscarExistencias($codigoArticulo) {
        
        $sql = "call spGetTiendasExistenciaGen('$codigoArticulo');";
        //echo $sql;
        //exit;
        $rs = $this->db->Execute($sql);
    ...
    function buscarArticuloTrans($codigoTienda,$codigoArticulo){
        
        $sql = "call spGetTiendasTransito('$codigoTienda','$codigoArticulo');";
        //echo $sql;
        //exit;
        $rs = $this->db->Execute($sql);
    ...
    function buscarClientes($nombreCliente) {
        ...
        $sql = "call spGetClientesFac('$nombreCliente',@out_status);";
        $rs = $this->db->Execute($sql);
    ...
    function validaClaveGere($reqAut,$ClaveGere){
        $sql = "call spValidaClaves('$reqAut','$ClaveGere',@out_esValido,@out_status);";
        $rs = $this->db->Execute ($sql);
        $rs->Close();
