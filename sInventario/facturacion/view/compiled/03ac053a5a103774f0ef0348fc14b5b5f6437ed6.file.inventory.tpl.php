<?php /* Smarty version Smarty-3.1.16, created on 2016-12-07 18:49:52
...
<?php if ($_valid && !is_callable('content_5512d9aad90558_29163965')) {function content_5512d9aad90558_29163965($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
...
?>    
    <tr id="inv-rowArt1">
        ...
        <td class="center" style="text-align: right;"><?php echo $_smarty_tpl->tpl_vars['INVENTARIO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['precioSinIV'];?>
</td>
