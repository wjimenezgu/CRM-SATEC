<?php /* Smarty version Smarty-3.1.16, created on 2016-11-23 16:14:43
         compiled from "../comprasnac/view/frmCompraNacReci.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10638873345833602ebf0890-77925266%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10638873345833602ebf0890-77925266',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5833602ee40f15_53932252',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'ID_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_5833602ee40f15_53932252')) {function content_5833602ee40f15_53932252($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
">
     									...
     									<td style=" text-align:right;">
     										<input name="cant[]" disabled id="cant<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idLinea'];?>
...
">
     									...
     									<td style=" text-align:right;">
     										<input name="costPed[]" disabled id="costPed<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idLinea'];?>
" type=text style="text-align: right; width:100px;" value="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['costoF'];?>
">
     									</td>     									
     									<td style=" text-align:right;">
     										<input name="actuCost[]" disabled id="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idLinea'];?>
" type=text style="text-align: right; width:100px;" value="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['costoUltCompra'];?>
">
     									</td>
     									<td style=" text-align:right;">
     										<input name="cost[]" disabled id="cost<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']+1;?>
" type=text style="text-align: right; width:100px;" value="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['costoPedido'];?>
">
     									</td>
     									
     									<td style=" text-align:right;">
     										<input name="utiActu[]" disabled id="utiActu<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idLinea']+1;?>
" type=text style="text-align: right; width:100px;" value="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['utiActual'];?>
">
     									</td>
     									<td style=" text-align:right;">
...
">
     									...
     									<td style=" text-align:right;">
     										<input name="precioActu[]" disabled id="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idLinea'];?>
" type=text style="text-align: right; width:100px;" value="<?php echo $_smarty_tpl->tpl_vars['DETPEDIDO_NAC']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['precioUnitarioF'];?>
">
     									</td>
     									<td style=" text-align:right;">
...
$(document).ready(function(){
    ...
    function DetalleValido(){
		...
		//	tmp = $('input[name^="cost"]').eq(numRow).val();
			tmp  = document.getElementById("cost"+numRow).value;
            tmp = tmp.trim();  
            if (tmp == ""){
            	tmp = "0.00";
            }
	...
	//		tmp = $('input[name^="cant"]').eq(numRow).val();
		...
		//	tmp = $('input[name^="precioNuevo"]').eq(numRow).val();
			tmp  = document.getElementById("precioNuevo"+numRow).value;
			tmp = tmp.trim();
		...
		if (impuestoCalculado != parseFloat($('#impuesto').val()).toFixed(2)){
		...
		if (totalGravado != parseFloat($('#gravado').val()).toFixed(2)){
		...
		if (totalCalculado != parseFloat($('#total').val()).toFixed(2)){
