<?php /* Smarty version Smarty-3.1.16, created on 2016-12-12 10:49:10
...
">
            <input type="hidden" id="porce_max_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_MAX_DESC']->value[0]['Valor'];?>
">
            <input type="hidden" id="porce_aut_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_AUT_DESC']->value[0]['Valor'];?>
">
            <input type="hidden" id="porce_uti_costo" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_UTI_COSTO']->value[0]['Valor'];?>
">            
...
$(document).ready(function(){
    ...
    function mathB(){
        ...
        var maxGereDesc = parseInt($("#porce_aut_desc").val());
