<?php /* Smarty version Smarty-3.1.16, created on 2016-12-02 13:42:28
	    	...
	    	if ($("#tipoAnulacion").val() == "A"){
    			...
    			// ES UNA DEVOLUCION PARCIAL DE ARTICULOS	
    				var properties = {
    			            ...
    			            async: false,
    			            cache: false,
    			            data: "pTableData=" + $tiraArti+"&idFactura="+$("#idFactura").val()+"&totalNota="+$("#totalNota").val()+"&totalivnota="+$("#totalIVNota").val()+"&userVendedor="+$('#idVendedor').val()+"&idTienda="+$('#idtienda').val()+"&razon="+$("#razonNota").val(),
    			            type: "GET",
