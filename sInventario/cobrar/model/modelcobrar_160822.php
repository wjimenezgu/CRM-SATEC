...
//echo $sql;exit;
    ...
    function impreFactura($codTienda,$idFactura,$esManual,$numFactuManual,$formaPago1,$autorizacion1,$montoPago1,$formaPago2,$autorizacion2,$montoPago2,$formaPago3,$autorizacion3,$montoPago3,$formaPago4,$autorizacion4,$montoPago4) {
    	...
    	$sql = "call spImpreFactura($codTienda,$idFactura,'$esManual','$numFactuManual','$formaPago1','$autorizacion1',$montoPago1,'$formaPago2','$autorizacion2',$montoPago2,'$formaPago3','$autorizacion3',$montoPago3,'$formaPago4','$autorizacion4',$montoPago4,@out_status);";
   //echo $sql;exit;
    	$rs = $this->db->Execute($sql);
