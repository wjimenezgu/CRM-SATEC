<?php
    ...
    foreach ($detalleDocu as $dato){
        ...
        $cmds .= substr($tiraEsp,1,12-strlen($dato["PrecioVenta"])).$dato["PrecioVenta"].substr($tiraEsp,1,12);
        $cmds .= substr($tiraEsp,1,12-strlen($dato["PrecioTotal"])).$dato["PrecioTotal"];
        $cmds .= $newLine;
        ++$contLineas ;
    }
    ...
    $cmds .= $SaltarLineas;
    $cmds .= substr($tiraEsp,1,90) ."       Total:               " .substr($tiraEsp,1,12-strlen($headerDocu[0]["subTotal"])).$headerDocu[0]["subTotal"];
    $cmds .= $newLine ;   
