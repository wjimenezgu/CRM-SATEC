...
<body>
    ...
    <div style="width:100%">
    	...
    	<input type="button" id="imprime" autofocus name="imprime"   style="margin-left:25%; margin-top:25%;font-size:48px" onclick="javascript:jsWebClientPrint.print('cmds=' + $('#cmds').val()+'&idTienda=' + $('#idTienda').val()+'&montototal='+$('#montototal').val()+'&descuento='+$('#descuento').val()+'&impuesto='+$('#impuesto').val()+'&Total='+$('#Total').val()+'&subtotal='+$('#subtotal').val());window.location.href ='index.php';" value="Presionar Enter para regresar ..." />
