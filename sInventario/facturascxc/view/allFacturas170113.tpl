		...
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-content">
							...
							<tr style="padding:0px;" id="tr{$LISTA_FACTURAS[lP].idFactura}">
                                <td style="width:385px; text-align:left"> 
                                	<a style="color:#004C66;" href="#" 
                                		...
                                		{IF $LISTA_FACTURAS[lP].Estado != 'ANULADA'} onclick="getDetFactura(this.id)"{/if}>{$LISTA_FACTURAS[lP].nombre}
                                	</a>
                                </td>
					...
					{IF $LISTA_FACTURAS[lP].Estado != 'ANULADA'} {$LISTA_FACTURAS[lP].Total} {/if}
				</td>
