		...
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				<div class="box-header well">
					...
					<input type="hidden" id="anulaOFF" value="{$ANULACXC_OFF}">
				...
				<div class="box-content">
					<table class="table table-striped table-bordered bootstrap-datatable" id="tblFacturas">
						<thead>
							<tr>
								...
								<th>Impresa</th>
								<th>Estado</th>
								<th {IF $ANULACXC_OFF eq "S"} class="hidden" {/if}>Acción</th>
							...
							<tr style="padding:0px;" id="tr{$LISTA_FACTURAS[lP].idFactura}">
                                <td style="width:385px; text-align:left"> 
                                	<a style="color:#004C66;" href="#" 
                                		...
                                		{IF $LISTA_FACTURAS[lP].Estado != 'ANULADA' || $DETANUCXC_OFF eq 'N'} onclick="getDetFactura(this.id)"{/if}>{$LISTA_FACTURAS[lP].nombre}
                                	</a>
                                </td>
					...
					{IF $LISTA_FACTURAS[lP].Estado != 'ANULADA' || $DETANUCXC_OFF eq 'N'} {$LISTA_FACTURAS[lP].Total} {/if}
				</td>
                                <td>{$LISTA_FACTURAS[lP].estadoImp}</td>
                                <td>{$LISTA_FACTURAS[lP].Estado}</td>
                                <td {IF $ANULACXC_OFF eq "S"} class="hidden" {/if} class="center">
							...
							<div class="span12">
                            	...
                            	<thead>
                                	<tr>
                                        ...
                                        <th {IF $ANULACXC_OFF eq "S"} class="hidden" {/if} style="text-align:center;"> Seleccionar</th>
                                    </tr>
                                </thead>
                                <tfoot>
    								<tr>
    									<td rowspan="2" colspan="5"></td>
      									...
      									<td {IF $ANULACXC_OFF eq "S"} class="hidden" {/if}>
    								...
    								<tr>   									
      									...
      									<td {IF $ANULACXC_OFF eq "S"} class="hidden" {/if}></td>
    								</tr>
    								<tr> 
    									<td colspan="5">    									
