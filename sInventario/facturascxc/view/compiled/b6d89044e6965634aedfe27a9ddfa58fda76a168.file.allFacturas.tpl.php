<?php /* Smarty version Smarty-3.1.16, created on 2017-02-05 12:20:24
         compiled from "../facturascxc/view/allFacturas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:103729915757fcd4fe37c679-97078387%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6d89044e6965634aedfe27a9ddfa58fda76a168' => 
    array (
      0 => '../facturascxc/view/allFacturas.tpl',
      1 => 1486322384,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103729915757fcd4fe37c679-97078387',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57fcd4fe54b761_53152466',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'NOMBRE_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_57fcd4fe54b761_53152466')) {function content_57fcd4fe54b761_53152466($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
"><input type="hidden" name="prev_value_imp" id="prev_value_imp" value="0">
					...
					<input type="hidden" id="anulaOFF" value="<?php echo $_smarty_tpl->tpl_vars['ANULACXC_OFF']->value;?>
">
					...
					<table class="table table-striped table-bordered bootstrap-datatable" id="tblFacturas">
						<thead>
							<tr>
								...
								<th>Impresa</th>
								<th>Estado</th>
								<th <?php if ($_smarty_tpl->tpl_vars['ANULACXC_OFF']->value=="S") {?> class="hidden" <?php }?>>Acción</th>
...
|<?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Obs'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Estado'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['estadoImp'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['NumFactura'];?>
"
                                		<?php if ($_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Estado']!='ANULADA'||$_smarty_tpl->tpl_vars['DETANUCXC_OFF']->value=='N') {?> onclick="getDetFactura(this.id)"<?php }?>><?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombre'];?>
     							...
     							<td style="width:70px;  text-align:right"><?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['NumFactura'];?>
</td>
					...
					<?php if ($_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Estado']!='ANULADA'||$_smarty_tpl->tpl_vars['DETANUCXC_OFF']->value=='N') {?> <?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Total'];?>
 <?php }?>
				</td>
                                ...
                                <td <?php if ($_smarty_tpl->tpl_vars['ANULACXC_OFF']->value=="S") {?> class="hidden" <?php }?> class="center">
							...
							<div class="span12">
                            	...
                            	<thead>
                                	<tr>
                                        ...
                                        <th <?php if ($_smarty_tpl->tpl_vars['ANULACXC_OFF']->value=="S") {?> class="hidden" <?php }?> style="text-align:center;"> Seleccionar</th>
                                    </tr>
                                </thead>
                                <tfoot>
    								<tr>
    									<td rowspan="2" colspan="5"></td>
      									...
      									<td <?php if ($_smarty_tpl->tpl_vars['ANULACXC_OFF']->value=="S") {?> class="hidden" <?php }?>>
    								...
    								<tr>   									
      									...
      									<td <?php if ($_smarty_tpl->tpl_vars['ANULACXC_OFF']->value=="S") {?> class="hidden" <?php }?>></td>
    								</tr>
    								<tr> 
    									<td colspan="5">    									
...
function getDetFactura(idFactura){
	...
	//
	if ((detFactura[8]=="ANULADA") || (detFactura[9]=="N") || ($("#anulaOFF").val() == "S"))  {
