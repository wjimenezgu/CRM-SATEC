							...
							<tr style="padding:0px;" id="tr{$LISTA_NOTAS[lP].idNota}">
                                <td style="width:385px; text-align:left"> 
                                	<a style="color:#004C66;" href="#" 
                                		id="{$LISTA_NOTAS[lP].idFactura}|{$LISTA_NOTAS[lP].nombre}|{$LISTA_NOTAS[lP].userVendedor}|{$LISTA_NOTAS[lP].subTotal}|{$LISTA_NOTAS[lP].descuento}|{$LISTA_NOTAS[lP].impuesto}|{$LISTA_NOTAS[lP].TotalN}|{$LISTA_NOTAS[lP].Obs}|{$LISTA_NOTAS[lP].Estado}|{$LISTA_NOTAS[lP].estadoImp}|{$LISTA_NOTAS[lP].NumFactura}"
                                		onclick="getDetFactura(this.id)">{$LISTA_NOTAS[lP].nombre}
                                	</a>
                                </td>
                                ...
                                <td style="width:385px; text-align:right">{$LISTA_NOTAS[lP].Total}</td>
