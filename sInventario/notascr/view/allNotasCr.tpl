		...
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-content">
				    <button type="button" class="btn btn-small btn-success" id="addNewNota"  onclick="goPage(7,0)" style='margin-bottom:12px; {if $ADDNOTA_OFF eq "S"} display:none;{/if}'><i class="icon-plus icon-white"></i> Agregar</button>
